...
const PlayersPage = () => {
  ...
  const [roleFilter, setRoleFilter] = useState('All'); // Filter for role: "All", "Batsman", "Bowler"
  ...
  // Filtered Players based on search and role
      ...
      <div className="flex-1 p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {filteredPlayers.map((player) => (
            <div
              key={player.id}
              className="bg-neutral-900 border border-neutral-800 rounded-xl overflow-hidden hover:border-cyan-500/50 transition group"
            >
